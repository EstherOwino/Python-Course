...
#If our car object doesn't have the method speak or attribute alive, then it doen't have the minimum #necessary attributes/methods to make it an animal hence generates an error  
animals = [Dog(), Cat(), Car()]
...
class Employee:
  ...
  #STATIC METHOD, best for general utility functions within a class
  #static methods don't have self, we are not working with any objects created from this class
  # static methods don't need an object(but can use an object) to be called from a class
  @staticmethod
